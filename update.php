		...
		<div class="container mt-3">
			...
			<input type = "hidden" name="id" value="<?php echo $emp_id ?>"> 
				...
				<div class="form-group">
					...
					<input class="form-control" type="email" name="emp_email" value="<?php $email =   $view->view_id_list("employee","empEmail","empId", $emp_id); ?>" required>
				</div>
				...
				<div class="form-group">
					...
					<input class="form-control" type="text" name="type" value="<?php $poss =   $view->view_id_list("employee","empType","empId", $emp_id); ?>">
				</div>
				<div class="form-group">
					<label for="empname">Designation</label>
					<input class="form-control" type="text" name="emp_designation" value="<?php $poss =   $view->view_id_list("employee","empDesignation","empId", $emp_id); ?>">
				</div>
				<div class="form-group">
					<label for="empname">Department</label>
					<input class="form-control" type="text" name="empDepartment" value="<?php $poss =   $view->view_id_list("employee","empDepartment","empId", $emp_id); ?>">
				</div>
				<div class="form-group">
