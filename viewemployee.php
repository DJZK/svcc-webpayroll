            ...
            <aside class="main-sidebar sidebar-light-primary elevation-4">
               ...
               with font-awesome or any other icon font library -->
                            ...
                            <li class="nav-item  menu-open">
                                <a href="viewemployee.php" class="nav-link active">
            ...
            <a href="viewaccounting.php" class="nav-link">
              ...
              <p>
                Accounting
                                ...
                                <li class="nav-item ">
                                <a href="status_admin.php" class="nav-link">
                                    <i class="nav-icon fas fa-user"></i>
                                    <p>
                                          Employee Records
                                    </p>
                ...
                <section class="content">
                    <div class="card card-outline card-primary">
                        ...
                        <div class="card-body" style="overflow-x:auto;">
                            ...
                            <table id="example" class="table  table-bordered table-condensed table-hover text-center"
                              ...
                              while($row = mysqli_fetch_assoc($resul)){ ?>
                                ...
                                <a href="controller/delete_admin.php?delete=<?php echo $row['empId']?>"
                        ...
                        <div class="card-footer clearfix">
                            <div class="m-1 float-right row">
                                <button class="btn  btn-sm btn-outline-primary float-right " data-toggle="modal"
                                    data-target="#exampleModalCenter"><i class="fa fa-plus"></i> Employee</button>
                                <!-- <button class="btn  btn-sm btn-outline-primary float-right ml-2" data-toggle="modal" data-target="#payslip"><i class="fa fa-plus"></i> Payslip</button> -->
                            </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action = "controller/add_info_admin.php">
