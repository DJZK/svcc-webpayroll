...
<?php include 'templates/nav.php'; ?>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="emppays.php" class="nav-link active">
  ...
  <section class="content-header">
    ...
    <section class="content">
      ...
      $sql = "SELECT * FROM employee INNER JOIN payslip ON employee.empId  = payslip.empId ";  
      $result = mysqli_query($conn, $sql);     
           ...
           while($row = mysqli_fetch_array($result)) {
                    ...
                    <td><?php echo $row['payslipId']; ?></td>
                            ...
                            <div class="btn-group">
                              <a href="update_payslip.php?update_id=<?php echo $row['payslipId']?>" class="btn btn-outline-primary  btn-track"><i class="fas fa-edit"></i></a>
                              <a href="controller/delete.php?payslip_id=<?php echo $row['payslipId']?>" class="btn btn-outline-primary  btn-track swalDefaultSuccess"><i class="fas fa-trash"></i></a>
                            </div>
